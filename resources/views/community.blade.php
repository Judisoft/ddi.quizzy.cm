...
<div class="theme-layout" style="overflow-x:hidden !important;">
	...
	<nav class="sidebar">
		<ul class="menu-slide">
			...
			<li class="menu-item-has-children">
				...
				<ul class="submenu">
					<li><a href="#" title="">Medxam <span class="badge badge-danger">New</span></a></li>
				</ul>
			</li>
			<li class="menu-item-has-children">
				<a class="" href="#" title="">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3">
						<div class="bg-light p-5 quiz-list" style="border-radius:10px;">
							...
							@forelse ($quizzies->take(20) as $quiz)
					...
					<div class="col-lg-9 col-md-9">
						<div class="search-section help-bg rounded">
							...
							<p>
								@if(count($top_quizzes) > 0)Popular quizzes: @endif
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/64c3172dcc26a871b02bb013/1h6d153fr';
    s1.charset='UTF-8';
