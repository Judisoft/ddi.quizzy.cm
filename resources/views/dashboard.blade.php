                        ...
                        <div class="col-lg-6">
                                        ...
                                        @forelse ($invitations as $invitation)
                                            <li>
                                                ...
                                                <div class="action-btns">
                                                    <a class="button soft-primary" uk-tooltip="We sent you an accept link via email">Accept</a>
                                                </div>
                                            </li>
                                        @empty
                                            <p class="text-center">Empty <br>Enjoy the silence</p>
                                        @endforelse
                            ...
                            <div class="d-widget mt-4">
                                ...
                                <ul class="upcoming-event">
                                    ...
                                    @empty
                                    <p class="text-center">No scheduled evaluation</p>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
