...
<section>
	<div class="gap bg-light" style="overflow-x: hidden;">
		<div class="container">
			<div class="row remove-ext30" style="border-radius:5px;">
				<div class="col-lg-12">
                    @if(Session::has('message'))
						<div class="rounded pt-3" style="background-color: #bce0ef; border:1px solid #4267B2;" uk-alert>
							<a class="uk-alert-close" uk-close></a>
							<p class="text-dark text-center">{{ Session::get('message') }}</p>
						</div>
					@endif
					<div class="title">
				...
				<div class="col-lg-4 col-md-4 col-sm-4" data-aos="fade-right">
					<div class="card-body mt-3 br-10 shadow-index">
						...
						<h2 class="text-center fw-700">XAF 1,000/Month</h2><br />
				...
				<div class="col-lg-4 col-md-4 col-sm-4" data-aos="slide-up">
					<div class="card-body border-plan br-10 shadow-index">
						...
						<h2 class="text-center fw-700" style="color:#4267B2;">XAF 2,000/3Months</h2><br />
						...
						<hr>
						<p><i class="icofont-check px-2 h3 text-main"></i> 3 months of access</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-4" data-aos="fade-left">
					<div class="card-body mt-3 br-10 shadow-index">
						...
						<h2 class="text-center fw-700">XAF 5,000/Year</h2><br />
...
<section>
	<div class="gap mt-3" style="overflow-x: hidden;">
		<div class="container">
			<div class="row remove-ext30" style="border-radius:5px;">
				<div class="col-lg-12">
					<div class="title">
