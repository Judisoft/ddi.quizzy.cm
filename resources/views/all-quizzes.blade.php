                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        @empty
                            <div class="col-lg-8 text-center mt-5">
                                <img src="{{ asset('images/resources/empty-folder2.png') }}" style="height:100px;width:100px;">
                                <h5 class="opacity-3 p-5">No Quiz available</h5>
                                <a href="{{ route('create.quiz') }}" class="mr-auto text-center"><button class="button small primary">create quiz</button></a>
                            </div>
                        @endforelse
                    </div>
