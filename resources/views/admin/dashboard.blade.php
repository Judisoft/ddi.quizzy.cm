...
<head>
    ...
    <meta name="description" content="Quizzy is an online quiz platform">
        ...
        <section id="content" class="content">
                                ...
                                <div class="card-body text-center">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 p-3">
                                            <div class="card bg-info text-white overflow-hidden mb-3 p-3">
                                                <div class="display-3">{{ $users->count() }}</div>
                                            </div>
                                        ...
                                        <div class="flex-grow-1 text-center">
                                            ...
                                            <div class="d-flex justify-content-around">
                                                ...
                                                <div class="text-center">
                                                    <h4 class="mb-1">{{ $verified_accounts->count() }}</h4>
                                        ...
                                        <div class="p-3 pb-2">
                                            ...
                                            <ul class="list-group list-group-borderless">
                                                ...
                                                <li class="list-group-item p-0 text-reset d-flex justify-content-between align-items-start">
                                                    ...
                                                    <span class="fw-bold">{{ $gen_know_quest->count() }}</span>
                                                    <li class="list-group-item p-0 text-reset d-flex justify-content-between align-items-start">
                                                        <div class="me-auto">General Knowledge</div>
                                                        <span class="fw-bold">{{ $gen_know_quest->count() }}</span>
                                                    </li>
                                                </li>
                                            </ul>
            ...
            <footer class="content__boxed mt-auto">
                <div class="content__wrap py-3 py-md-1 d-flex flex-column flex-md-row align-items-md-center">
                    <div class="text-nowrap mb-4 mb-md-0">Copyright &copy; 2023 <a href="#" class="ms-1 btn-link fw-bold">Quizzy v1.0</a></div>
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <div class="flex justify-center">
                            <button style="font-family: 'Libre Baskerville', serif;height:35px;width:35px;padding:2px;background-color: #4267B2;color:#fff;font-size: 20px;border-radius: 5px;border:#e5e7eb;">Q</button>
                        </div>

                        <!-- Brand title -->
                        <div class="brand-title">
                            <span class="px-2" style="font-family: 'Rowdies', sans-serif;color: #FFF;font-size: 26px;">
                                Quizzy
                            </span>
                        </div>
