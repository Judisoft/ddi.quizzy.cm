                                    ...
                                    <div class="tabs tab-content">
                                        ...
                                        <div id="quiz" style="display:none">
                                            ...
                                            <div id="content_1" class="tabcontent px-5">
                                                <div class="d-widget-title" style="word-wrap: break-word;"><h4 id="question"></h4></div>
                                                <div class="uk-margin p-2">
                                                    <div class="d-flex flex-row">
                                                        <div onclick="checkAnswer('A')" class="option"></div>
                                                        <div class="px-3"><label for="A" id="A"></label></div>
                                                    </div>
                                                </div>
                                                <div class="uk-margin p-2">
                                                    <div class="d-flex flex-row">
                                                        <div onclick="checkAnswer('B')" class="option"></div>
                                                        <div class="px-3"><label for="B" id="B"></label></div>
                                                    </div>
                                                </div>
                                                <div class="uk-margin p-2">
                                                    <div class="d-flex flex-row">
                                                        <div onclick="checkAnswer('C')" class="option"></div>
                                                        <div class="px-3"><label for="C" id="C"></label></div>
                                                    </div>
                                                </div>
                                                <div class="uk-margin p-2">
                                                    <div class="d-flex flex-row">
                                                        <div onclick="checkAnswer('D')" class="option"></div>
                                                        <div class="px-3"><label for="D" id="D"></label></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
function renderQuestion(){
    ...
    // ask if user really wants to close the ongoing quiz
    ...
    question.innerHTML = "<small class='bg-warning p-1'>Question</small>" + "<small class='bg-warning p-1'>" +(runningQuestion + 1) + "</small>" + "<br /><br/ /> " + `${'<h4>'+q.content+'</h4>'}`;
    choiceA.innerHTML = `${'<h6>'+q.A+'</h6>'}`;
    choiceB.innerHTML = `${'<h6>'+q.B+'</h6>'}`;
    choiceC.innerHTML = `${'<h6>'+q.C+'</h6>'}`;
    choiceD.innerHTML = `${'<h6>'+q.D+'</h6>'}`;
...
function scoreRender(){
    ...
    scoreDiv.innerHTML = `<div class="d-widget p-2 mt-4 text-center">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><p class='fw-700 text-secondary'>High Score</p> <h4 class='fw-700 text-secondary uk-text-break'>${high_score ? high_score : 0}</h4></td>
                                        <td><p class='fw-700 text-secondary'>Points</p> <h4 class='fw-700 text-secondary uk-text-break'>${score}/{{ $quiz_points }}</h4></td>
                                        <td><p class='fw-700 text-secondary'>Questions</p><h4 class='fw-700 text-secondary uk-text-break'>${correctAnswers}/${lastQuestion + 1}</h4></td>
                                    </tr>
                                    <tr><a class="text-center" onclick="return location.reload();">Reatake this Quiz</a></tr>
                                </tbody>
                            </table>
                        </div>`
    ...
    //         questReport.innerHTML += `<div class="alert alert-info">
    ...
    //                                     <br>
    //                                     Answer: ${questItem.question.answer}
    //                                 </div>`
    //     })
    // })
