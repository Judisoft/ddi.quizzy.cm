...
Route::get('/medxam', [App\Http\Controllers\FrontEndController::class, 'medxam'])->name('medxam');
...
Route::get('user_quiz/{quiz_id}/quiz-questions', [App\Http\Controllers\QuizController::class, 'createUserQuiz'])->name('user.quiz')->middleware('verify.user.role');
...
Route::get('/quizzes/create-a-quiz', [App\Http\Controllers\QuizQuestionsController::class, 'create'])->name('create.quiz')->middleware('verify.user.role'); 
...
Route::get('/questions/subjects/{subject_id}/{topic_id}', [App\Http\Controllers\QuizPracticeModeController::class, 'sortQuestions']);
...
Route::get('quest/add-question', [App\Http\Controllers\QuestController::class, 'create'])->name('create.question')->middleware('verify.user.role');
...
Route::get('quest/{sub_id}/{topic_id}/next/{id}', [App\Http\Controllers\QuestController::class, 'getNextQuestion']);
Route::get('quest/{sub_id}/{topic_id}/previous/{id}', [App\Http\Controllers\QuestController::class, 'getPreviousQuestion']);
...
Route::get('create-evaluation', [App\Http\Controllers\EvaluationsController::class, 'createEvaluation'])->name('evaluation.create')->middleware('verify.user.role');
